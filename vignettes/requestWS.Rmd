...
```{r,echo=TRUE,message=FALSE, warning=FALSE}
  ...
  connectToWS(apiID="ws_public","guestphis@supagro.inra.fr","guestphis")
```

```{r,echo=TRUE,eval=FALSE,message=FALSE, warning=FALSE}
  # If you want to access to a private web service, you have to insert the address of the WS and the port
  connectToWS(apiID="ws_private","guestphis@supagro.inra.fr","guestphis",url = "147.99.7.5:8080/phenomeapi/resources/")
```
